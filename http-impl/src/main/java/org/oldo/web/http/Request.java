...
import org.oldo.web.http.tempfiles.TempFile;
import org.oldo.web.http.tempfiles.TempFiles;
import org.oldo.web.http.util.ConnectionUtil;
import org.oldo.web.http.util.UriUtil;
...
public final class Request implements IRequest {
    ...
    public Request(TempFiles tempFiles, InputStream in, OutputStream out, InetAddress inetAddress) {
        ...
        headers.put("plankton-client-ip", remoteIp);
    }
    ...
    public void handleBy(IServer server) throws IOException {
        try {
            ...
            try {
                ...
                ConnectionUtil.close(in);
                ConnectionUtil.close(out);
    ...
    private String saveTmpFile(ByteBuffer b, int offset, int len) {
        ...
        if (len > 0) {
            ...
            try {
                ...
                ConnectionUtil.close(fileOutputStream);
            }
        }
        return path;
    }
